...
public class BookFile {
    ...
    @JoinColumn(name = "book_id", referencedColumnName = "id") // Create new column with name "book_id" on BookFile Table
                                                               // reference to column associated with field "id" of Book Class
    private Book book;
}